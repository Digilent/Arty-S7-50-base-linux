...
# INT32_MIN is set in /home/digilent/work/git/Petalinux-Arty-S7-50/Arty-S7-50/build/tmp/sysroots/plnx_microblaze/usr/include/stdint.h by:
# #define INT32_MIN        -2147483648
...
# -- Edward Moy
#
if test -f /home/digilent/work/git/Petalinux-Arty-S7-50/Arty-S7-50/build/tmp/sysroots/plnx_microblaze/usr/include/stdint.h; then
  case "$(grep '^#define INT32_MIN' /home/digilent/work/git/Petalinux-Arty-S7-50/Arty-S7-50/build/tmp/sysroots/plnx_microblaze/usr/include/stdint.h)" in
