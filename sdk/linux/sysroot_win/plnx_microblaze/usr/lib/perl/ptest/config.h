 ...
 *	instance.
 */
#define ARCHNAME "microblazeel-linux"		/**/
 ...
 */
#define CPPSTDIN "microblazeel-xilinx-linux-gnu-gcc   -mlittle-endian   -mcpu=v10.0           -mxl-barrel-shift -mno-xl-soft-mul -mxl-multiply-high  -mno-xl-soft-div  -mxl-pattern-compare -mno-xl-reorder -Wl,--hash-style=gnu --sysroot=/home/digilent/work/git/Petalinux-Arty-S7-50/Arty-S7-50/build/tmp/sysroots/plnx_microblaze -E"
#define CPPMINUS "-"
#define CPPRUN "microblazeel-xilinx-linux-gnu-gcc   -mlittle-endian   -mcpu=v10.0           -mxl-barrel-shift -mno-xl-soft-mul -mxl-multiply-high  -mno-xl-soft-div  -mxl-pattern-compare -mno-xl-reorder -Wl,--hash-style=gnu --sysroot=/home/digilent/work/git/Petalinux-Arty-S7-50/Arty-S7-50/build/tmp/sysroots/plnx_microblaze -E"
#define CPPLAST "-"
