...
XS_EUPXS(XS_threads_tid)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1210 "threads.xs"
        ithread *thread;
#line 1399 "threads.c"
#line 1212 "threads.xs"
...
XS_EUPXS(XS_threads_detach)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1354 "threads.xs"
        ithread *thread;
        int detach_err;
        dMY_POOL;
#line 1574 "threads.c"
#line 1358 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS_EUPXS(XS_threads_equal)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1465 "threads.xs"
        int are_equal = 0;
#line 1709 "threads.c"
#line 1467 "threads.xs"
        PERL_UNUSED_VAR(items);
...
XS_EUPXS(XS_threads_is_running)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1608 "threads.xs"
        ithread *thread;
#line 1897 "threads.c"
#line 1610 "threads.xs"
        /* Object method only */
        if ((items != 1) || ! sv_isobject(ST(0))) {
...
XS_EUPXS(XS_threads_is_detached)
{
    ...
    PERL_UNUSED_VAR(cv); /* -W */
    {
#line 1625 "threads.xs"
        ithread *thread;
#line 1923 "threads.c"
#line 1627 "threads.xs"
        PERL_UNUSED_VAR(items);
        thread = S_SV_to_ithread(aTHX_ ST(0));
        MUTEX_LOCK(&thread->mutex);
