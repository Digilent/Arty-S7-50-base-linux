...
;
	SV *	RETVAL;
#line 6681 "Storable.xs"
  RETVAL = pretrieve(aTHX_ f);
#line 6839 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 6689 "Storable.xs"
  RETVAL = mretrieve(aTHX_ sv);
#line 6859 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
;
	SV *	RETVAL;
#line 6697 "Storable.xs"
  RETVAL = dclone(aTHX_ sv);
#line 6879 "Storable.c"
	RETVAL = sv_2mortal(RETVAL);
	ST(0) = RETVAL;
    }
    XSRETURN(1);
...
XS_EUPXS(XS_Storable_last_op_in_netorder)
{
    ...
    SP -= items;
    {
#line 6707 "Storable.xs"
  bool result;
#line 6899 "Storable.c"
