...
#define __GMP_CC "microblazeel-xilinx-linux-gnu-gcc   -mlittle-endian   -mcpu=v10.0           -mxl-barrel-shift -mno-xl-soft-mul -mxl-multiply-high  -mno-xl-soft-div  -mxl-pattern-compare -mno-xl-reorder -Wl,--hash-style=gnu "
#define __GMP_CFLAGS "-O2 -pedantic -O2 -pipe -g -feliminate-unused-debug-types -fdebug-prefix-map=/tmp/scratch/petalinux-yocto/yocto_sdk_minimal_2017.2/build/tmp/work/microblazeel-v10.0-bs-cmp-mh-div-xilinx-linux/gmp/6.1.1-r0=/usr/src/debug/gmp/6.1.1-r0 -fdebug-prefix-map=/tmp/scratch/petalinux-yocto/yocto_sdk_minimal_2017.2/build/tmp/sysroots/x86_64-linux= -fdebug-prefix-map=/home/digilent/work/git/Petalinux-Arty-S7-50/Arty-S7-50/build/tmp/sysroots/plnx_microblaze="
